...
#write.csv(gba_allyears, "gba6585_diagnoses_allyears_detailed_20210219.csv", row.names = F)
...
summary(gba_allyears_full_diagnosis$Anorexia) # do not summary all, dataset is too big
...
#write.csv(gba_allyears_full_diagnosis, "gba6585_diagnoses_allyears_full_diagnosis_20210219.csv", row.names = F)
...
#write.csv(diagnoses_totalyears_per_person_gba_EA, "gba_EA_diagnoses_totalyear_per_person_20210219.csv", row.names = F)
...
#write.csv(diagnoses_totalyears_per_person_sib, "siblings_diagnoses_totalyear_per_person_20210219.csv", row.names = F)
...
#write.csv(diagnoses_totalyears_per_person_sib_EA, "siblings_EA_diagnoses_totalyear_per_person_20210219.csv", row.names = F)
...
#write.csv(descriptive_table, "descriptive_table_diagnoses_allpop_20210225.csv", row.names = F)
...
#write.csv(descriptive_table_output, "descriptive_table_diagnoses_allpop_20210225_output.csv", row.names = F)
...
write.csv(diagnoses_by_sex, "diagnoses_by_sex_gba_20210225.csv", row.names=F)
...
write.csv(diagnoses_by_yrs, "diagnoses_by_yrs_gba_20210225.csv", row.names=F)
...
write.csv(diagnoses_by_yrs_output, "diagnoses_by_yrs_gba_20210225_output.csv", row.names=F)
...
write.csv(diagnoses_by_yrs_sex, "diagnoses_by_yrs_sex_gba_20210225.csv", row.names=F)
...
write.csv(diagnoses_by_yrs_sex_output, "diagnoses_by_yrs_sex_gba_20210225_output.csv", row.names=F)
...
write.csv(diagnoses_by_diploma, "diagnoses_by_diploma_gba_20210225.csv", row.names=F)
...
write.csv(diagnoses_by_diploma_output, "diagnoses_by_diploma_gba_20210225_output.csv", row.names=F)
...
write.csv(diagnoses_by_sex, "diagnoses_by_sex_20220729.csv", row.names=F)
...
write.csv(diagnoses_by_yrs, "diagnoses_by_yrs_20220729.csv", row.names=F)
...
write.csv(diagnoses_by_yrs_output, "diagnoses_by_yrs_20220729_output.csv", row.names=F)
write.xlsx(diagnoses_by_yrs_output, "diagnoses_by_yrs_20220729_output.xlsx", row.names=F)
...
write.csv(diagnoses_by_yrs_sex, "diagnoses_by_yrs_sex_20220729.csv", row.names=F)
...
write.csv(diagnoses_by_yrs_sex_output, "diagnoses_by_yrs_sex_20220729_output.csv", row.names=F)
...
write.csv(diagnoses_by_diploma, "diagnoses_by_diploma_20220729.csv", row.names=F)
...
diagnoses_by_diploma_output
write.csv(diagnoses_by_diploma_output, "diagnoses_by_diploma_20220729_output.csv", row.names=F)
...
write.csv(diagnoses_by_birth_order, "diagnoses_by_birth_order_20220729.csv", row.names=F)
...
write.csv(diagnoses_by_birth_order_output, "diagnoses_by_birth_order_output_20220729.csv", row.names=F)
...
write.csv(diagnoses_by_birthyear, "diagnoses_by_birthyear_20220729.csv", row.names=F)
...
write.csv(diagnoses_by_birthyear_output, "diagnoses_by_birthyear_output_20220729.csv", row.names=F)
...
cooc <- diagnoses_totalyears_per_person_gba[,2:23]
cooc <- cooc[, !2:3] # Remove Conduct and ODD 
head(cooc)
cooc <- as.matrix(cooc)
...
out # 
write.table(out, "matrix_cooccurrence_count_20210223.txt")
write.xlsx(out, "matrix_cooccurrence_count_20210223.xlsx")
...
write.table(test, "matrix_cooccurrence_freq_20210223.txt")
write.xlsx(test, "matrix_cooccurrence_freq_20210223.xlsx")
...
library(psych)
polycor <- polychoric(diagnoses_totalyears_per_person_gba[, 2:24][, !2:3]) #remove ocd and conduct
polycor
#Warning message:
#In cor.smooth(mat) : Matrix was not positive definite, smoothing was done
matrix_plycor <- polycor$rho
write.table(matrix_plycor, "matrix_polychoriccorrelation_20221024.csv")
write.xlsx(matrix_plycor, "matrix_polychoriccorrelation_20221024.xlsx")
...
cooc <- diagnoses_totalyears_per_person_sib_EA[,2:25]
cooc <- cooc[, !2:3] # Remove Conduct and ODD 
head(cooc)
cooc <- cooc[, !21]#remove any
cooc <- cooc[, !15:16]#remove anorexia and bulimia
...
write.table(out, "matrix_cooccurrence_count_sibEA_20221024.txt")
write.xlsx(out, "matrix_cooccurrence_count_sibEA_20221024.xlsx")
...
write.table(test, "matrix_cooccurrence_freq_sibEA_20221024.txt")
write.xlsx(test, "matrix_cooccurrence_freq_sibEA_20221024.xlsx")
...
write.table(matrix_plycor, 
            "matrix_polychoriccorrelation_sibEA_20221024.csv")
write.xlsx(matrix_plycor, 
            "matrix_polychoriccorrelation_sibEA_20221024.xlsx")
...
codefile <- as.data.frame(fread("H:/Data/Diagnoses/Diagnoses_code_preregistered.csv",
                                header=T))
trait_list <- codefile$trait
...
primsec_totalyears_per_person_gba <- get_diagnoses_totalyear_per_person(gba_allyears_primsec,
                                                                          "gba")
#write.csv(primsec_totalyears_per_person_gba, "gba_primsec_totalyear_per_person_20221021.csv", row.names = F)
primsec_totalyears_per_person_gba <- fread("gba_primsec_totalyear_per_person_20221021.csv")
primsec_totalyears_per_person_gba <- as.data.frame(primsec_totalyears_per_person_gba)
...
write.xlsx(count, "count_primary_secondary_20221021.xlsx", row.names = F)
...
sib_EA_allyears <- gba_allyears[which(gba_allyears$RINPERSOON %in% sib_EA_list),]
...
codefile <- as.data.frame(fread("H:/Data/Diagnoses/Diagnoses_code_preregistered.csv",
                                header=T))
trait_list <- codefile$trait
sib_EA_allyears_primsec <- sib_EA_allyears[,!(names(sib_EA_allyears) %in% trait_list)]


primsec_totalyears_per_person_sib_EA<- get_diagnoses_totalyear_per_person(sib_EA_allyears_primsec,
                                                                        "sib_EA")
#write.csv(primsec_totalyears_per_person_sib_EA, "sib_EA_primsec_totalyear_per_person_20221021.csv", row.names = F)
primsec_totalyears_per_person_sib_EA<- fread("sib_EA_primsec_totalyear_per_person_20221021.csv")
primsec_totalyears_per_person_sib_EA<- as.data.frame(primsec_totalyears_per_person_sib_EA)
...
count <- cbind(count_primsec, count_only_second)
write.xlsx(count, "count_primary_secondary_sibEA_20221024.xlsx", row.names = F)
